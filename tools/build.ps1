...
param(
    [ValidateSet('hello', 'tests', 'windows-demo', 'windows-tests', 'eventloop', 'controls-demo', 'stack-demo', 'cursor-demo', 'split-demo', 'scroll-demo', 'form-demo', 'input-inspector', 'all')]
    [string]$Target = 'hello',
    [string]$Fpc = $env:FPC
)
...
switch ($Target) {
    ...
    'split-demo' {
        Build-One (Join-Path $Root 'examples\split_demo\split_demo_windows.pas') 'split_demo_windows.exe' $windows
    }
    'scroll-demo' {
        Build-One (Join-Path $Root 'examples\scroll_demo\scroll_demo_windows.pas') 'scroll_demo_windows.exe' $windows
    }
    'form-demo' {
        Build-One (Join-Path $Root 'examples\form_demo\form_demo_windows.pas') 'form_demo_windows.exe' $windows
    }
    'input-inspector' {
