...
Phases 0–5, 5.1, 5.2, 6A, **6B.1–6B.4**, and **6C** are complete (visual review passed). Next: **6D — Checkbox, RadioButton, Label**. Phase 5.2.1 deferred resize remains experimental. Keep ANSI generation and the differential renderer portable. Keep Win32 in `src/platform/windows` and termios in `src/platform/unix`. Keep controls in `src/controls` and layouts in `src/layouts` free of platform units. Full repaint means rewrite all cells, not erase the terminal (`docs/adr/0006-full-repaint-without-clear.md`). Layout: `docs/adr/0008-layout-model.md`. Cursor: `docs/adr/0009-logical-cursor-manager.md`. Split/capture: `docs/adr/0010-split-container-mouse-capture.md`. Mouse dispatcher + ScrollView: `docs/adr/0011-mouse-dispatcher-scrollview.md`.
